...
BLOG_AUTHOR = "James Kerr"  # (translatable)
BLOG_TITLE = "disconsented"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://disconsented.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://disconsented.com/"
BLOG_EMAIL = "jpm.kerr@outlook.com"
BLOG_DESCRIPTION = "FOSS developer and PC Building Enthusiast"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/categories/", "Tags"),
        ("/rss.xml", "RSS feed"),
		("https://kiwiirc.com/client/irc.esper.net/#disconsented", "Web IRC"),		
...
FILTERS = {
	".html": [filters.html_tidy_wrap_attr]
}
...
# is in the manual.
COMMENT_SYSTEM_ID = "disconsentedcom"
