...
BLOG_AUTHOR = "Disconsented"  # (translatable)
BLOG_TITLE = "Disconsented"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://disconsented.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://disconsented.com/"
BLOG_EMAIL = "admin@disconsented.com"
BLOG_DESCRIPTION = "FOSS enthusist with a focus on minecraft"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("https://kiwiirc.com/client/irc.esper.net/?#disconsented", "Web chat"),
    ),
}
